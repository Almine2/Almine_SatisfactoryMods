...
void UDecreaseInventorySlotBPLib::DIS_SetNumOfAdditionalInventorySlots(AFGUnlockSubsystem* TargetUnlockSubsystem, int32 size)
{
  if (TargetUnlockSubsystem != nullptr) {
    TargetUnlockSubsystem->mNumAdditionalInventorySlots = size;
  }
}
...
void UDecreaseInventorySlotBPLib::DIS_SetNumAdditionalArmEquipmentSlots(AFGUnlockSubsystem* TargetUnlockSubsystem, int32 size)
{
  if (TargetUnlockSubsystem != nullptr) {
    TargetUnlockSubsystem->mNumAdditionalArmEquipmentSlots = size;
  }
}
